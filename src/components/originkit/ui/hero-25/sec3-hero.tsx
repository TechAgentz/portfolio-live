...
import { ParticleBand } from "@/components/originkit/ui/hero-25/particle-band";
import { ScaleFrame } from "@/components/originkit/ui/hero-25/scale-frame";

const A = "/originkit/hero-25";
...
/** Figma / source: "Ahead." uses --font-canela-deck-family (Canela Deck Bold).
 *  Packaged as --font-canela-deck → bold face for this section only. */
const CANELA = {
  fontFamily: "var(--font-canela-deck), Georgia, serif",
} as const;
...
const Badge = ({ fontSize }: { fontSize: string }) => (
  ...
  >
    ...
    >
      A senior product &amp; engineering studio
    </p>
    <BadgeEdge side="left" />
...
const PhoneFrame = () => (
  <div data-hero className="relative h-[874px] w-[402px] overflow-clip bg-[#0b0b0c]">
    {/* (Design's built-in nav removed — the site has its own fixed Navbar.) */}
    ...
    <div className="absolute left-1/2 top-[130px] flex w-[610px] -translate-x-1/2 flex-col items-center gap-[50px] p-[10px]">
      <div className="relative flex w-full shrink-0 flex-col items-center gap-[24px]">
        ...
        <div className="relative flex w-full shrink-0 flex-col items-center gap-[10px] text-center">
          ...
          >
            A tight-knit collective of senior engineers, designers, and product
            thinkers.
          </p>
        </div>
      </div>
      ...
      <div className="relative flex w-full shrink-0 flex-col items-center gap-[24px]">
        ...
        <div className="relative flex w-full shrink-0 flex-col items-center gap-[10px] text-center">
          <div
            ...
            className={`${REVEAL} relative shrink-0 whitespace-nowrap tracking-[-0.96px]`}
          >
            <p className="mb-0 font-geist text-[48px] font-medium leading-[1.2] text-white">
              We Build Exceptional
            </p>
            <p className="text-[48px] leading-[1.2]">
              <Highlighted slab="highlight-lg.svg" padX={6} padY={0}>
                Digital Experiences.
              </Highlighted>
            </p>
          </div>
...
const DesktopFrame = () => (
  <div data-hero className="relative h-[955px] w-full overflow-clip bg-[#0b0b0c]">
    ...
    <div className="absolute left-1/2 top-[131px] flex w-[610px] -translate-x-1/2 flex-col items-center gap-[36px] p-[10px]">
      <div className="relative flex w-full shrink-0 flex-col items-center gap-[24px]">
        <Badge fontSize="17px" />
...
export const Sec3Hero = () => (
  // section, not <main> — the page already renders its own <main> landmark
  <section id="top" className="w-full bg-[#0b0b0c]">
