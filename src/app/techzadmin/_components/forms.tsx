  ...
  return (
    <Card>
      <form action={action} className="space-y-4">
        ...
        <Actions cancelHref="/techzadmin/team" />
      </form>
    </Card>
  );
}
  ...
  return (
    <Card>
      <form action={action} className="space-y-4">
        ...
        <Field label="Sort order" name="order" type="number" defaultValue={record?.order ?? 0} />
        <Actions cancelHref="/techzadmin/projects" />
      </form>
    </Card>
  );
}
  ...
  return (
    <Card>
      <form action={action} className="space-y-4">
        ...
        <Actions cancelHref="/techzadmin/blog" />
      </form>
    </Card>
  );
}
  ...
  return (
    <Card>
      <form action={action} className="space-y-4">
        ...
        <Field label="Sort order" name="order" type="number" defaultValue={record?.order ?? 0} />
        <Actions cancelHref="/techzadmin/testimonials" />
      </form>
    </Card>
  );
}
  ...
  return (
    <Card>
      <form action={action} className="space-y-4">
        ...
        <Field label="Sort order" name="order" type="number" defaultValue={record?.order ?? 0} />
        <Actions cancelHref="/techzadmin/expertise" />
      </form>
    </Card>
  );
}
  ...
  return (
    <Card>
      <form action={action} className="space-y-4">
        ...
        <Textarea label="Body" name="body" defaultValue={record?.body} required />
        <Field label="Sort order" name="order" type="number" defaultValue={record?.order ?? 0} />
        <Actions cancelHref="/techzadmin/values" />
      </form>
    </Card>
  );
}
