...
const nav = [
  { href: "/techzadmin", label: "Dashboard", exact: true },
  { href: "/techzadmin/team", label: "Team" },
  ...
  { href: "/techzadmin/sections", label: "Section Headings" },
  { href: "/techzadmin/settings", label: "Site Settings" },
];
