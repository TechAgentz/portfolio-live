...
export async function saveMember(fd: FormData) {
  ...
  revalidateAll("/techzadmin/team");
  redirect("/techzadmin/team?flash=saved");
}
...
export async function saveProject(fd: FormData) {
  ...
  revalidateAll("/techzadmin/projects");
  redirect("/techzadmin/projects?flash=saved");
}
...
export async function savePost(fd: FormData) {
  ...
  revalidateAll("/techzadmin/blog");
  redirect("/techzadmin/blog?flash=saved");
}
...
export async function saveTestimonial(fd: FormData) {
  ...
  revalidateAll("/techzadmin/testimonials");
  redirect("/techzadmin/testimonials?flash=saved");
}
...
export async function saveExpertise(fd: FormData) {
  ...
  revalidateAll("/techzadmin/expertise");
  redirect("/techzadmin/expertise?flash=saved");
}
...
export async function saveProcess(fd: FormData) {
  ...
  redirect("/techzadmin/process?flash=saved");
}
...
export async function saveValue(fd: FormData) {
  ...
  revalidateAll("/techzadmin/values");
  redirect("/techzadmin/values?flash=saved");
}
...
export async function saveSections(fd: FormData) {
  ...
  revalidatePath("/");
  revalidatePath("/techzadmin/sections");
  redirect("/techzadmin/sections?flash=saved");
}
...
export async function saveSettings(fd: FormData) {
  ...
  revalidatePath("/");
  revalidatePath("/techzadmin/settings");
  redirect("/techzadmin/settings?flash=saved");
}
